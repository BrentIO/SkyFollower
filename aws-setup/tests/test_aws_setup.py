...
class TestProvision:
    def test_create_executes_without_prompt_when_no_replacement(self, capsys):
        ...
        out = _mod.provision(cf, "skyfollower", "body", [], assume_yes=False, interactive=False)
    ...
    def test_replacement_without_yes_non_interactive_aborts(self):
        ...
        with pytest.raises(SystemExit) as exc:
            _mod.provision(cf, "skyfollower", "body", [], assume_yes=False, interactive=False)
    ...
    def test_replacement_with_yes_executes(self):
        ...
        _mod.provision(cf, "skyfollower", "body", [], assume_yes=True, interactive=False)
        assert "execute_change_set" in cf.calls
