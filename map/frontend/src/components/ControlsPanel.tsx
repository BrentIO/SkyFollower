...
// toggle) with the icon buttons for the "Fullscreen", "Labels: All",
// "Trails: All", "Range Outline", and "Map Labels" toggles, in that
// top-to-bottom order. Icon buttons share the exact rendering mechanism
// (IconButton, toggleButtonClass coloring) as AircraftDetailPanel's action
// row, sized via IconButton's "md" size prop to match the recenter
// button's own h-9 w-9 -- AircraftDetailPanel's row keeps IconButton's
// default size and its own horizontal layout, unrelated to this column.
