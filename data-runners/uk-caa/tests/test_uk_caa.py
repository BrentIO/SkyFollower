...
_apply_manufacturer_model = _mod._apply_manufacturer_model
...
# ---------------------------------------------------------------------------
# Tests: _apply_manufacturer_model
# ---------------------------------------------------------------------------

class TestApplyManufacturerModel:
    ...
    def test_designator_not_found_leaves_field_unset(self):
...
class TestRunPipeline:
    ...
    def test_manufacturer_model_set_from_type_lookup_end_to_end(self):
        r = self._make_redis()
        r.json.return_value.get.return_value = {"manufacturer_model": "BOEING 787-9 (Dreamliner)"}
