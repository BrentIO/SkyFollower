...
class TestPublishCompletionStats:
    ...
    def test_mqtt_connect_timeout_does_not_raise(self):
        ...
        with patch("tc_caa_main.mqtt.Client") as mock_cls:
            mock_client = MagicMock()
    ...
    def test_mqtt_publishes_records_imported(self):
        ...
        with patch("tc_caa_main.mqtt.Client", return_value=mc):
    ...
    def test_mqtt_root_topic(self):
        assert MQTT_ROOT == "SkyFollower/runner/tc-caa"
...
class TestNetwork:
    ...
    def test_url_reachable(self):
        assert_url_reachable(_mod.REGISTER_URL, "tc-caa", headers={"User-Agent": "P5Software SkyFollower"})
