    ...
    <div className="flex flex-col gap-6 md:h-full md:min-h-0">
      <div className="flex shrink-0 flex-col gap-6">
        ...
        <div className="flex flex-col gap-2 md:hidden">
          ...
          <div className={`grid gap-2 ${isNew ? "grid-cols-1" : "grid-cols-2"}`}>
            <button
              type="button"
              onClick={onDiscard}
              disabled={!isNew && !dirty}
              className="rounded-md border border-slate-300 px-3 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 disabled:opacity-40 dark:border-slate-600 dark:text-slate-200 dark:hover:bg-slate-800"
            >
              Discard
            </button>
            {!isNew && (
              <button
                type="button"
                onClick={onDelete}
                className="rounded-md border border-red-300 px-3 py-2.5 text-sm font-medium text-red-600 hover:bg-red-50 dark:border-red-800 dark:hover:bg-red-950"
              >
                Delete
              </button>
            )}
